...
def PAI_to_HTML(summary_path, model_performance_path, plots_directory):
    ...
    with open('HTML_output/html_template_click_RD.html', 'r') as template_file:
    ...
    with open('HTML_output/output.html', 'w') as f:
